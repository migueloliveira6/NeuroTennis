...
class TennisPredictor:
    ...
    def save_model(self):
        ...
        joblib.dump(self.model, os.path.join(MODEL_PATH, 'tennis_surface_elo_model1.pkl'))
        joblib.dump(self.scaler, os.path.join(MODEL_PATH, 'tennis_surface_elo_scaler1.pkl'))
        ...
        }, os.path.join(MODEL_PATH, 'tennis_surface_elo_data1.pkl'))
    ...
    def load_saved_model(self):
        ...
        try:
            self.model = joblib.load(os.path.join(MODEL_PATH, 'tennis_surface_elo_model1.pkl'))
            self.scaler = joblib.load(os.path.join(MODEL_PATH, 'tennis_surface_elo_scaler1.pkl'))
...
def main():
    ...
    if all(os.path.exists(os.path.join(MODEL_PATH, f)) for f in [
        'tennis_surface_elo_model1.pkl',
        'tennis_surface_elo_scaler1.pkl',
        'tennis_surface_elo_data1.pkl'
    ]):
